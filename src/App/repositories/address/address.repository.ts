...
export abstract class AddressRepository implements IAddressRepository{
    ...
    abstract create: (params: {customerMatizeId: string, data: CreateAddressDto}) => Promise<void>;
    abstract update: (params: { matizeId: string; data: UpdateAddressDto; }) => Promise<void>;
